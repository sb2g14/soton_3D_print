            ...
            <tbody>
                @foreach($finished_jobs as $job) 
                    ...
                    <tr class="text-left {{$printclass}}">
                        ...
                        <td data-th="Name">
                            <a href="mailto:{{$job->customer_email}}?Subject=Job {{ $job->id }} | FEE 3D Printing Service"
                                target="_top">{{$job->customer_name}}</a>
                        </td>
                        ...
                        @else
                            <td data-th="Completed by">{{ $job->staff_finished->name() }} </td>
                        @endif
