            ...
            <div class="col-sm-6 text-left job-details">
                <div class="alert alert-info text-left">
                    <p>
                        ...
                        Approved on: <b>{{ $job->approved_at()->toDayDateTimeString() }}</b> by: <b>{{$job->staff_approved->name()}}</b><br>
                        Completed on: <b>{{ $job->finished_at()->toDayDateTimeString() }}</b> by: <b>{{$job->staff_finished->name()}}</b><br>
