...
{{--@if($member->CWP_date)--}}
    ...
    <div class="container well text-left">
        <div>
            Details on how to claim pay for time spent demonstrating are available at the <a href="https://www.southampton.ac.uk/hr/services/uniworkforce/index.page#introduction" target="_blank">UniWorkForce website</a>.

            Refer to the <a href="https://www.southampton.ac.uk/hr/services/uniworkforce/index.page#worker" target="_blank">&lsquo;Worker&rsquo; tab</a> for instructions on &lsquo;How to get paid&rsquo;.
            ...
            Refer to the <a href="https://www.southampton.ac.uk/hr/services/uniworkforce/index.page#documents" target="_blank">&lsquo;Documents&rsquo; tab</a> for the UniworkForce Timesheet that needs to be completed when claiming.
            ...
            <ol>
                ...
                <li>Fill in your hours worked for each date. @if($workinghours) You attended the following sessions: {{implode(", ",$workinghours)}}. You can also add preperation and training time to this.@endif</li>
