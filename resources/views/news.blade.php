	...
	<div class=" container well">
	    <div class="row">
	    	<div class="col-xs-12 text-left">
	    		...
	    		<p>
	    			You will all receive an email from Mailgun on your soton email later today that will ask you to agree to receive emails from us. We currently use this service for password resets. The email looks like this:
	    		</p>
	    		<p>
	    			Hi there,
	    		</p>
	    		<p>
	    			Mailgun account "University of Southampton" provided your address to test their integration with Mailgun. Please click the link below if you agree to receive emails from their account.<br>
	    			I Agree
	    		</p>
	    		<p>
	    			If you didn't expect this email, please unsubscribe.<br>
					Thanks, Mailgun Team
	    		</p>
				<p>
					Please accept this invitation and then register yourself with your soton-email under <a href="http://3dprint.clients.soton.ac.uk/">http://3dprint.clients.soton.ac.uk/</a>. Please note that this is currently separate from the university accounts. For security reasons we encourage you to use a strong password and NOT to use the same password as for your university account!!!
				</p>
				<p>
					I expect everyone to spend 10minutes to click around the website to familiarise themselves with the website before coming to the workshop. Below is a short introduction on the most important things you need to know.
				</p>
				...
				<p>As a demonstrator you now need to log in to the webpage and click on</p>
