        ...
        @can('staff_manage')
            <div class="col-lg-2 pull-right">
                <span class="text-justify" data-placement="top" data-toggle="popover"
                    ...
                    <a type="button" class="btn btn-success" href="/rota/event/create">Add Event</a>
                </span>
            </div>
                                                    ...
                                                    @foreach($s->events() as $e)
                                                        <span class="text-justify" data-placement="top" data-toggle="popover"
                                                            ...
                                                            <a class="badge badge-{{$e->type}}"
                                                                @can('staff_manage') href="/rota/event/{{$e->id}}/edit" @endcan>
                                                                {{$e->name}}
                                                            </a>
                                                        </span>
                                                    @endforeach
...
<!--DISPLAY EVENT-->
                    <div class="col-sm-12 text-left well col-{{$rota->type}}">
                        <a @can('staff_manage') href="/rota/event/{{$rota->id}}/edit" @endcan>{{$rota->name}}</a>:
                        {{$rota->dateString()}}
                    </div>
                @endif
            @endforeach
